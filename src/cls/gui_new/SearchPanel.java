...
public class SearchPanel extends JPanel {
	...
	public SearchPanel() {
		...
		searchbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(SearchPanel.this, "Please input correct provider name",
				...
				try {
					...
					JOptionPane.showMessageDialog(SearchPanel.this, "Please input correct product name",
							"Input Error", JOptionPane.ERROR_MESSAGE);
				}
				...
				try {
					...
					JOptionPane.showMessageDialog(SearchPanel.this, "Please input correct price(.00)", 
							"Input Error",JOptionPane.ERROR_MESSAGE);
				}
				...
				try {
					...
					JOptionPane.showMessageDialog(SearchPanel.this, "Please input correct discount(.00)", 
							"Input Error",JOptionPane.ERROR_MESSAGE);
				}
					...
					if(rate > 0 && rate < 0.9) {
						...
						JOptionPane.showMessageDialog(SearchPanel.this, "Please input correct discount(0<discount<0.9)", 
								"Input Error",JOptionPane.ERROR_MESSAGE);
						return;
					}
				...
				try {
					...
					JOptionPane.showMessageDialog(SearchPanel.this, "Please input correct expirePeriod(int)", 
							"Input Error",JOptionPane.ERROR_MESSAGE);
				}
				
				FormEvent fe = new FormEvent(this,provider,proName,proPrice,dRate,expirePeriod,status);
				//System.out.println(provider+", "+proName+", "+proPrice+", "+dRate+", "+expirePeriod+", "+status);
		...
		Border outerBorder = BorderFactory.createTitledBorder("Search Coupon");
	...
	public void setSearchPanelListener(FormListener listener) {
